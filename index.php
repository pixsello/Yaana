...
<!--                                <a href="#!"><button type="button" class="default-button"> Read More</button></a>-->
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="content">
                                ...
                                <p>With GPS enabled tech, locate and ride YAANA with ease.  </p>
<!--                                <a href="#!"><button type="button" class="default-button"> Read More</button></a>-->
                            </div>
                        </div>
                    </div>
        ...
        <section id="pricing " class="pricing-section angle-sp yaana-background"> 
            <div class="container"> 
                <div class="row"> 
                    <div class="col-md-12">
                    <img src="images/yaana-background.jpg" class="img-responsive">
                </div>
                </div><!-- END ROW -->
