...
-->
                    ...
                    <div class="col-md-5"> 
                        <div class="text-center">
                            <img src="images/yaana-Bike.png" class="img-responsive">
                        </div>
                    </div><!-- END COL -->
                </div><!-- END ROW -->
            </div><!-- END CONTAINER -->
